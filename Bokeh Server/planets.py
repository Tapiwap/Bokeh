...
# Drawing the static glyphs
earth_orbit = fig.circle(x=0, y=0, radius=1, line_color='blue',line_alpha=0.5,fill_color=None, line_width=2)
mars_orbit=fig.circle(x=0, y=0, radius=0.7, line_color='red',line_alpha=0.5,fill_color=None, line_width=2)
sun=fig.circle(x=0, y=0, radius=0.2, line_color=None, fill_color="yellow", fill_alpha=0.5)
...
earth=fig.circle(x='x_earth', y='y_earth', size=12, fill_color='blue', line_color=None, fill_alpha=0.6, source=earth_source)
mars=fig.circle(x='x_mars', y='y_mars', size=12, fill_color='red', line_color=None, fill_alpha=0.6, source=mars_source)
